...
module.exports = Provider = React.createClass({
    ...
    noLogo: function noLogo(event) {
        $(event.currentTarget).remove();
    },
    check: function check(val, prefix, postfix) {
        var acc = [];
        if (_.isArray(val)) {
    ...
    render: function render() {
        ...
        function makeContact(contact) {
            ...
            return React.createElement(
                'table',
                { className: "contact", key: name + email + role },
                React.createElement(
                    'tr',
                    null,
                    React.createElement(
        ...
        if (_.has(data, 'name')) {
            title = React.createElement(
                ...
                React.createElement(
                    'a',
                    { href: "/portal/recordsets/" + data.uuid },
                    data.name
                )
            );
        }
        ...
        description = React.createElement(
            'p',
            { id: "description", className: "clearfix" },
            logo,
            desc
        );
        ...
        return React.createElement(
            'div',
            { id: "attribution", className: "clearfix section scrollspy" },
            React.createElement(
                'h4',
                { className: "title" },
                'From Recordset'
            ...
            React.createElement(
                'div',
                { id: "provider-info", className: "clearfix" },
                title,
                link,
                description,
                con
