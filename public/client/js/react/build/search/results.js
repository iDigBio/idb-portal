...
var Results = module.exports = React.createClass({
    ...
    componentWillMount: function componentWillMount() {
        ...
        this.getResults = _.debounce(function () {
            ...
            var d = new Date(),
                searchState = self.state.search,
                query = queryBuilder.makeSearchQuery(searchState);
            var now = d.getTime();
    ...
    viewChange: function viewChange(event) {
    ...
    resultsScroll: function resultsScroll(e) {
    ...
    render: function render() {
        ...
        ['list', 'labels', 'images', 'recordsets'].forEach(function (item) {
            ...
            li.push(React.createElement(
                'li',
                { key: 'tab-' + item, onClick: self.viewChange, 'data-value': item, className: cl },
        ...
        return React.createElement(
            'div',
            { id: "results", className: "clearfix", onScroll: this.resultsScroll },
            React.createElement(
                'ul',
                { id: "results-menu", className: "pull-left" },
                li
            ),
            React.createElement(
                'div',
                { className: "pull-right total" },
                'Total: ',
                helpers.formatNum(parseInt(this.state.total))
            ),
            results
        );
    }
...
var ResultsList = React.createClass({
    ...
    columnCheckboxClick: function columnCheckboxClick(e) {
    ...
    sortColumn: function sortColumn(e) {
        ...
        var dir,
            search = _.cloneDeep(this.props.search),
            name = e.currentTarget.attributes['data-term'].value,
            sort = { name: name },
            sorting = search.sorting,
            curlength = sorting.length;
    ...
    openRecord: function openRecord(e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    render: function render() {
        ...
        columns.forEach(function (item) {
            if (sorted.name === item) {
                ...
                headers.push(React.createElement(
                    'th',
                    { key: 'header-' + item, id: item, className: "data-column", style: style, 'data-term': item, 'data-sort': sorted.order, onClick: self.sortColumn },
                ...
                headers.push(React.createElement(
                    'th',
                    { key: 'header-' + item, id: item, className: "data-column", style: style, 'data-term': item, onClick: self.sortColumn },
                    fields.byTerm[item].name
                ));
            }
        });
        ...
        headers.push(React.createElement(
            'th',
            { key: 'header-select', style: { width: '80px', fontSize: '10px', textAlign: 'center' } },
            React.createElement(
                'button',
                { className: "pull-left", 'data-toggle': "modal", 'data-target': "#column-list" },
                'Columns'
            )
        ));
        this.props.results.forEach(function (item, index) {
            ...
            tds.push(React.createElement(
                'td',
                { key: 'row-' + index + '-open', className: "open" },
                React.createElement(
                    'a',
                    { className: "pull-left", id: item.uuid, onClick: self.openRecord, title: "view full record" },
                    'view'
                )
            ));
        ...
        if (this.props.loading) {
            rows.push(React.createElement(
                'tr',
                { key: 'loading-row', className: "no-results-row" },
                React.createElement(
                    'td',
            ...
            rows.push(React.createElement(
                'tr',
                { key: 'row-no-results', className: "no-results-row" },
                React.createElement(
                    'td',
                    { colSpan: columns.length + 1 },
                    'No Matching Records'
        ...
        _.each(fields.searchGroups, function (val) {
                        ...
                        group.push(React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'label',
                                    null,
                                    React.createElement('input', { name: field.term, onChange: self.columnCheckboxClick, type: "checkbox", checked: checked, disabled: disabled }),
                                    ' ',
                                    field.name
                                )
                            )
            ...
            list.push(React.createElement(
                'table',
                { key: "group-" + group, className: "group-table" },
                group
            ));
        });
        ...
        return React.createElement(
            'div',
            { id: "result-list", className: "panel" },
            React.createElement(
                'div',
                { id: "column-list", className: "modal fade" },
                React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'button',
                                { onClick: this.resetColumns, id: "reset" },
                                'Reset'
                            ),
                            React.createElement(
                                'button',
                                { type: "button", className: "close pull-right", 'data-dismiss': "modal" },
                                React.createElement(
                                    'span',
                                    { 'aria-hidden': "true" },
                                    '×'
            ...
            React.createElement(
                'table',
                { id: "data-table", className: "table table-condensed" },
                React.createElement(
                    'thead',
                    null,
                    React.createElement(
...
var ResultsLabels = React.createClass({
    displayName: 'ResultsLabels',

    mixins: [PureRender],
    makeLabel: function makeLabel(result, id) {
        var data = result.indexTerms,
            raw = result.data;
        var txt = '';
        var content = [],
            middle = [];
        ...
        if (_.has(raw, 'dwc:scientificNameAuthorship')) {
            auth = React.createElement(
                'span',
                { className: "author" },
                raw['dwc:scientificNameAuthorship']
            );
        }
        ...
        if (l.length > 0) {
            middle.push(React.createElement(
                'span',
                { key: "locality", className: "locality" },
                l.join(', ')
            ));
        }
        ...
        var c = [],
            tits = ['Institution', 'Collection', 'Catalog Number'];
        ...
        if (c.length > 0) {
            middle.push(React.createElement(
                'span',
                { key: "collection", className: "collection" },
                c.join(', ')
            ));
        }
        if (middle.length > 0) {
        ...
        if (taxa.length > 0) {
            content.push(React.createElement(
                'span',
                { key: "higher", className: "highertaxa" },
                taxa.join(', ')
            ));
        }
        ...
        return React.createElement(
            'div',
            { key: 'label-' + id, className: "pull-left result-item result-label" },
            React.createElement(
                'h5',
                { className: "title", title: "click to open record" },
                React.createElement(
                    'a',
                    { href: '/portal/records/' + result.uuid, target: result.uuid },
                    title,
                    ' ',
                    auth
                )
    ...
    errorImage: function errorImage(e) {
        //debugger
        e.target.attributes['src'].value = '/portal/img/notavailable.jpg';
    },
    openMedia: function openMedia(e) {
        e.preventDefault();
    ...
    render: function render() {
        ...
        if (labels.length === 0 && this.props.loading === false) {
            labels.push(React.createElement(
                'div',
                { key: "no-records", className: "no-records" },
                React.createElement(
                    'h4',
                    null,
                    'No Matching Records'
        ...
        if (this.props.loading) {
            ...
            labels.push(React.createElement(
                'div',
                { key: 'loading-div', className: "label-loading clearfix pull-left" },
                React.createElement('i', { className: "spinner" })
            ));
        }
        return React.createElement(
            'div',
            { id: "result-labels", className: "panel" },
            labels
        );
    }
});
...
var ResultsImages = React.createClass({
    displayName: 'ResultsImages',

    mixins: [PureRender],
    getImageOnlyResults: function getImageOnlyResults(search) {

        var d = new Date(),
            self = this,
            searchState = _.cloneDeep(search);
    ...
    makeImageText: function makeImageText(data) {},
    makeImage: function makeImage(uuid, record) {
        var count = record.indexTerms.mediarecords.indexOf(uuid) + 1 + ' of ' + record.indexTerms.mediarecords.length;
        var name = [],
            specimen = record.data,
            index = record.indexTerms;
        ...
        return React.createElement(
            'a',
            { className: "image", target: uuid, href: "/portal/mediarecords/" + uuid, key: 'image-' + uuid },
            React.createElement(
                'span',
                { className: "img-count" },
                count
    ...
    render: function render() {
        ...
        if (images.length === 0 && !self.state.loading) {
            images.push(React.createElement(
                'div',
                { key: "no-images", className: "no-images" },
                React.createElement(
                    'h4',
                    null,
                    'No Images Available'
        ...
        if (self.state.loading) {
            images.push(React.createElement(
                'div',
                { key: "loading-images", id: "loading-images", className: "clearfix" },
                React.createElement('i', { className: "spinner" })
            ));
        }
        return React.createElement(
            'div',
            { id: "results-images", className: "panel" },
            React.createElement(
                'div',
                { id: "images-wrapper", className: "clearfix" },
                images
            )
        );
    }
...
var Providers = React.createClass({
    ...
    render: function render() {
        ...
        var list = _.map(this.props.attribution, function (item) {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'a',
                        { href: "/portal/recordsets/" + item.uuid, target: '_' + item.uuid },
                        item.name
                    )
                ),
                React.createElement(
                    'td',
                    null,
                    helpers.formatNum(item.itemCount)
                ),
        ...
        return React.createElement(
            'div',
            { id: "provider-results", className: "panel" },
            React.createElement(
                'table',
