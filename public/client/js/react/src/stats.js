    ...
    const navList = () => {
        return (
            <ul id="side-nav-list">
                ...
                <li><a href="#temporal-coverage" style={navLinkStyle}>Temporal Coverage</a></li>
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-lg-7 col-lg-offset-2 col-md-9 col-md-offset-1 col-sm-10" id="container">
                    ...
                    <h3 id="google-analytics">Google Analytics Data</h3>

                    <p>
                        <a
                            href="https://lookerstudio.google.com/embed/reporting/e1efb265-1581-4bfe-961c-e7c3b1795208/page/kIV1C"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            Open Google Analytics Dashboard in a new tab
                        </a>
                    </p>
