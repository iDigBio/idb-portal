...
var Row = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'td',
                { className: "field-name", style: { width: '50%' } },
                name
            ),
...
var Section = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { id: this.props.name, className: cl },
            React.createElement(
                'h5',
                null,
...
var Flags = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { id: "flags", style: { display: this.props.active ? 'block' : 'none' } },
            React.createElement(
                'table',
    ...
    render: function render() {
        ...
        sorder.forEach(function (sec, index) {
            if (_.has(self.props.record, sec)) {
                ...
                record.push(React.createElement(Section, { key: 'sec-' + sec, name: sec, data: self.props.record[sec], active: active }));
                cnt++;
            }
        });
        ...
        if (this.props.raw.indexTerms.flags) {
            ...
            flagsTab = React.createElement(
                'li',
                { className: this.state.active == 'flags' ? 'active' : '', 'data-tab': "flags" },
                'Flags'
            );
        }
        ...
        return React.createElement(
            'div',
            { id: "data", className: "scrollspy section" },
            React.createElement(
                'ul',
                { onClick: this.tabClick },
                React.createElement(
                    'li',
                    { className: this.state.active == 'record' ? 'active' : '', 'data-tab': "record" },
                    'Data'
                ),
                flagsTab,
                React.createElement(
                    'li',
                    { className: this.state.active == 'raw' ? 'active' : '', 'data-tab': "raw" },
                    'Raw'
                )
            ),
            React.createElement(
                'div',
                { id: "record", className: "clearfix", style: { display: this.state.active == 'record' ? 'block' : 'none' } },
                record
            ),
            flags,
            React.createElement(
                'div',
                { id: "raw", style: { display: this.state.active == 'raw' ? 'block' : 'none' } },
...
var Img = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'a',
            { href: '/portal/mediarecords/' + this.props.keyid, title: "click to open media record" },
...
var Gallery = React.createClass({
    ...
    render: function render() {
        if (_.has(this.props.data, 'mediarecords')) {
            ...
            return React.createElement(
                'div',
                { id: "media", className: "scrollspy section" },
                React.createElement(
                    'h4',
                    { className: "title" },
                    'Media'
...
var Map = React.createClass({
    ...
    render: function render() {
        if (_.has(this.props.data, 'geopoint')) {
            return React.createElement(
                'div',
                { id: "map", className: "clearfix scrollspy section" },
                React.createElement(
                    'div',
                    { id: "map-wrapper" },
...
module.exports = React.createClass({
    ...
    navList: function navList() {
        ...
        var map = this.props.record.indexTerms.geopoint ? React.createElement(
            'li',
            null,
            React.createElement(
                'a',
        ...
        var media = this.props.record.indexTerms.hasImage ? React.createElement(
            'li',
            null,
            React.createElement(
                'a',
    ...
    taxaBreadCrumbs: function taxaBreadCrumbs() {
        var order = [],
            values = [],
            self = this;
    ...
    namedTableRows: function namedTableRows(data, list, dic) {
        var values = [];
    ...
    render: function render() {
        var data = this.props.record.data,
            index = this.props.record.indexTerms; //resp._source.data['idigbio:data'];
        var has = [],
            canonical = {};
        var record = {};
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: "pull-left sec collection" },
                            React.createElement(
                                'table',
                                null,
