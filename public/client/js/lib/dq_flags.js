module.exports = {
    "datecollected_bounds": "Date Collected out of bounds (Not between 1700-01-02 and the present time (date of Indexing).",
    "dwc_acceptednameusageid_added": "tbd",
    "dwc_basisofrecord_invalid": "tbd",
    "dwc_basisofrecord_paleo_conflict": "The record contains paleo context terms but Basis of Record is not FossilSpecimen",
    ...
    "dwc_taxonrank_invalid": "Darwin Core Taxon Rank supplied is not contained in Taxonomic Rank GBIF Vocabulary.",
    ...
    "taxon_match_failed": "Unable to match a taxon in GBIF Backbone Taxonomy"
};
