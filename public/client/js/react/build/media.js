...
var Media = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { key: this.props.keyid, id: "media-wrapper", className: "scrollspy section clearfix" },
            React.createElement(
                'a',
                { className: "clearfix", target: '_' + this.props.keyid, href: link, title: "click to open original media file" },
            ...
            React.createElement(
                'a',
                { className: "media-link hidden-print", href: link, download: this.props.keyid, target: '_' + this.props.keyid },
                'Download Media File'
            )
        );
    }
...
var Table = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { id: "data-table", className: "scrollspy" },
            React.createElement(
                'ul',
...
var Group = React.createClass({
    ...
    render: function render() {
        if (_.has(this.props.record, 'indexTerms') && this.props.record.indexTerms.mediarecords.length > 1) {
            ...
            for (id in media) {
                if (media[id] != this.props.keyid) {
                    imgs.push(React.createElement(
                        'a',
                        { href: '/portal/mediarecords/' + media[id], title: "click to open media record", key: media[id] },
            ...
            return React.createElement(
                'div',
                { id: "other-images", className: "clearfix scrollspy section" },
                React.createElement(
                    'h4',
                    { className: "title" },
                    'Other Media'
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: "col-lg-7 col-lg-offset-2 col-md-10 col-sm-10", id: "container" },
                    React.createElement(
                        'h1',
                        { id: "banner" },
                        'Media Record'
