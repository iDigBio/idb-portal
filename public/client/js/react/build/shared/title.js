...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function(){
        if(_.has(this.props.data,'indexTerms')){
            ...
            return (
                React.createElement("div", {id: "title"}, 
                    ...
                    React.createElement("h2", null, 
                        "From ", React.createElement("a", {href: '/portal/recordsets/'+this.props.attribution.uuid}, this.props.attribution.name)
                    )
                )
            );             
        }else{
            ...
            return (
                React.createElement("div", {id: "title"}, 
                    React.createElement("h1", null, React.createElement("span", {className: "title"}, React.createElement("em", null, "No Associated Specimen Record"))), 
                    React.createElement("h2", null, 
                        "From ", React.createElement("a", {href: '/portal/recordsets/'+this.props.attribution.uuid}, this.props.attribution.name)
                    )
                )
