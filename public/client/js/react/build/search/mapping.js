...
module.exports = React.createClass({
    ...
    defaultMappingProps: function defaultMappingProps(type) {
        if (type == 'box') {
    ...
    mappingType: function mappingType(e) {
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { className: "clearfix section " + this.props.active, id: "mapping" },
            React.createElement(
                'div',
                { className: "option-group", id: "mapping-options" },
                React.createElement(
                    'span',
                    { className: "title" },
                    'Lat/Lon Bounds'
                ...
                React.createElement(
                    'a',
                    { className: "btn", onClick: this.resetBounds },
                    'Clear'
                ),
                React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement('input', { type: "radio", name: "mapping-type", id: "box", value: "box", checked: this.state.type == 'box', onChange: this.mappingType }),
                        'Rectange'
                    ),
                    React.createElement(
                        'label',
                        { className: "radio-inline" },
                        React.createElement('input', { type: "radio", name: "mapping-type", id: "radius", value: "radius", checked: this.state.type == 'radius', onChange: this.mappingType }),
                        'Circle'
                    )
                ),
                type
...
var Box = React.createClass({
    ...
    statics: {
        defaultBounds: function defaultBounds() {
            return {
                top_left: {
                    lat: false,
                    lon: false
    ...
    currentBounds: function currentBounds() {
    ...
    degreeChange: function degreeChange(event) {
...
var Radius = React.createClass({
    ...
    boundsChange: function boundsChange(e) {
